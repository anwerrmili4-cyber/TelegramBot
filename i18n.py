...
TRANSLATIONS = {
    ...
    "topup_sol_instructions": {
        "fr": "◎ <b>DÉPÔT SOL</b>\n\n<b>Réseau obligatoire : Solana</b>\n\nEnvoyez au moins <b>{minimum} SOL</b> à cette adresse :\n<code>{address}</code>\n\nAprès l’envoi, appuyez sur <b>Vérifier le paiement</b> dans l’heure. Le bot calcule uniquement l’augmentation du solde, prend le cours SOL/USDT en direct et crédite votre portefeuille en USDT. Chaque paiement ne peut être crédité qu’une seule fois.\n\n⚠️ Utilisez uniquement le réseau <b>Solana</b>.",
        "en": "◎ <b>SOL DEPOSIT</b>\n\n<b>Required network: Solana</b>\n\nSend at least <b>{minimum} SOL</b> to this address:\n<code>{address}</code>\n\nAfter sending, press <b>Check payment</b> within one hour. The bot calculates only the wallet balance increase, locks the live SOL/USDT rate, and credits your wallet in USDT. Each payment can be credited only once.\n\n⚠️ Use only the <b>Solana</b> network.",
        "ar": "◎ <b>إيداع SOL</b>\n\n<b>الشبكة المطلوبة: Solana</b>\n\nأرسل ما لا يقل عن <b>{minimum} SOL</b> إلى هذا العنوان:\n<code>{address}</code>\n\nبعد الإرسال، اضغط <b>تحقق من الدفع</b> خلال ساعة واحدة. يحسب البوت زيادة رصيد المحفظة فقط ويثبت سعر SOL/USDT المباشر ثم يضيف الرصيد بالدولار الرقمي. لا يمكن إضافة الدفعة نفسها أكثر من مرة.\n\n⚠️ استخدم شبكة <b>Solana</b> فقط.",
    },
