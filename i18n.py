...
TRANSLATIONS = {
    ...
    "welcome": {
        "fr": "[[HTML]]🛍️ <b>Bienvenue sur Black Market !</b>\n\nSalut {first_name} ! 👋\n\nNous proposons des produits numériques premium aux meilleurs prix. Livraison rapide, sécurisée et entièrement automatisée.\n\n<blockquote>🏪 <b>Shop</b> — Parcourir et acheter des produits\n🤑 <b>Dépôt</b> — Ajouter des fonds au portefeuille\n👤 <b>Mon profil</b> — Solde, commandes et paramètres\n🔧 <b>API développeur</b> — Revente et commandes automatisées\n⭐️ <b>Parrainer et gagner</b> — Inviter des amis et gagner des récompenses</blockquote>\n\n📣 Chaîne : <a href=\"https://t.me/blackmarketBotChannel\">Rejoindre la chaîne</a>\n📣 Groupe : <a href=\"https://t.me/Blackmarketgrp\">Rejoindre le groupe</a>\n🛎️ Support : <a href=\"https://t.me/b9hdc2\">Contacter le support</a>\n\n<b>Conditions d’utilisation :</b> <a href=\"{terms_url}\">Lire ici</a>\n\n<blockquote>⚠️ <b>Notification</b>\nSupport disponible de 21h00 à 00h00 IST</blockquote>\n\nChoisissez une option ci-dessous pour continuer !",
        "en": "[[HTML]]🛍️ <b>Welcome to Black Market!</b>\n\nHey {first_name}! 👋\n\nWe offer premium digital products at the best prices. Fast, secure, and fully automated delivery.\n\n<blockquote>🏪 <b>Shop</b> — Browse &amp; buy products\n🤑 <b>Deposit</b> — Add funds to your wallet\n👤 <b>My Profile</b> — Balance, orders &amp; settings\n🔧 <b>Developer API</b> — Reseller &amp; automated ordering\n⭐️ <b>Refer &amp; Earn</b> — Invite friends &amp; earn rewards</blockquote>\n\n📣 Channel: <a href=\"https://t.me/blackmarketBotChannel\">Join Channel</a>\n📣 Group: <a href=\"https://t.me/Blackmarketgrp\">Join Group Chat</a>\n🛎️ Support: <a href=\"https://t.me/b9hdc2\">Contact Support</a>\n\n<b>Terms of Service:</b> <a href=\"{terms_url}\">Read here</a>\n\n<blockquote>⚠️ <b>Notification</b>\nSupport Time is 9:00PM to 12:00AM IST</blockquote>\n\nChoose an option below to continue !",
        "ar": "[[HTML]]🛍️ <b>مرحباً بك في Black Market!</b>\n\nمرحباً {first_name}! 👋\n\nنقدم منتجات رقمية مميزة بأفضل الأسعار، مع تسليم سريع وآمن ومؤتمت بالكامل.\n\n<blockquote>🏪 <b>المتجر</b> — تصفح المنتجات واشترها\n🤑 <b>الإيداع</b> — أضف رصيداً إلى محفظتك\n👤 <b>ملفي الشخصي</b> — الرصيد والطلبات والإعدادات\n🔧 <b>واجهة المطور</b> — إعادة البيع والطلبات الآلية\n⭐️ <b>ادعُ واربح</b> — ادعُ أصدقاءك واكسب المكافآت</blockquote>\n\n📣 القناة: <a href=\"https://t.me/blackmarketBotChannel\">انضم إلى القناة</a>\n📣 المجموعة: <a href=\"https://t.me/Blackmarketgrp\">انضم إلى المجموعة</a>\n🛎️ الدعم: <a href=\"https://t.me/b9hdc2\">تواصل مع الدعم</a>\n\n<b>شروط الخدمة:</b> <a href=\"{terms_url}\">اقرأ هنا</a>\n\n<blockquote>⚠️ <b>تنبيه</b>\nوقت الدعم من 9:00 مساءً إلى 12:00 صباحاً بتوقيت الهند</blockquote>\n\nاختر خياراً أدناه للمتابعة!",
    },
    ...
    "menu_affiliate": {"fr": "⭐️ Parrainer & gagner", "en": "⭐️ Refer & Earn", "ar": "⭐️ ادعُ واربح"},
    "menu_account": {"fr": "👤 Mon profil", "en": "👤 My Profile", "ar": "👤 ملفي الشخصي"},
    ...
    "bybit_disabled": {
        "fr": "⛔ Bybit est désactivé. Utilisez Binance Pay ou une méthode on-chain.",
    ...
    "topup_sol_checking": {"fr": "🔎 <b>Vérification du paiement Solana</b>\n\nProgression : <b>{progress}%</b>\n{bar}\n\nRecherche des transactions reçues…", "en": "🔎 <b>Checking Solana payment</b>\n\nProgress: <b>{progress}%</b>\n{bar}\n\nSearching incoming transactions…", "ar": "🔎 <b>جارٍ التحقق من دفعة Solana</b>\n\nالتقدم: <b>{progress}%</b>\n{bar}\n\nجارٍ البحث عن المعاملات الواردة…"},
    "topup_sol_not_found": {"fr": "⚠️ Aucune nouvelle transaction Solana trouvée. Vérifiez que vous avez envoyé des SOL à l’adresse affichée, puis réessayez.", "en": "⚠️ No new Solana transaction was found. Make sure you sent SOL to the displayed address, then try again.", "ar": "⚠️ لم يتم العثور على معاملة Solana جديدة. تأكد من إرسال SOL إلى العنوان الظاهر ثم حاول مرة أخرى."},
    "topup_sol_instructions": {
        "fr": "◎ <b>DÉPÔT SOL</b>\n\n<b>Réseau obligatoire : Solana</b>\n\nEnvoyez au moins <b>{minimum} SOL</b> à cette adresse :\n<code>{address}</code>\n\nAprès l’envoi, appuyez sur <b>Vérifier le paiement</b> dans l’heure.\n\n⚠️ Utilisez uniquement le réseau <b>Solana</b>.",
        "en": "◎ <b>SOL DEPOSIT</b>\n\n<b>Required network: Solana</b>\n\nSend at least <b>{minimum} SOL</b> to this address:\n<code>{address}</code>\n\nAfter sending, press <b>Check payment</b> within one hour.\n\n⚠️ Use only the <b>Solana</b> network.",
        "ar": "◎ <b>إيداع SOL</b>\n\n<b>الشبكة المطلوبة: Solana</b>\n\nأرسل ما لا يقل عن <b>{minimum} SOL</b> إلى هذا العنوان:\n<code>{address}</code>\n\nبعد الإرسال، اضغط <b>تحقق من الدفع</b> خلال ساعة واحدة.\n\n⚠️ استخدم شبكة <b>Solana</b> فقط.",
    },
